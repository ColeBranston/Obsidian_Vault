...
- **Rule of thumb:** apply E at the start, and after every symbol you read. That's why an NFA with ε-arrows out of its start state already has several live states before reading anything (see [[Set View of an NFA]])
